...
| [04](04-the-keyboard-gesture-and-the-readout.md) | Zooming the focused account from the keyboard | front-end | 02 | 10/10 | done |
| [05](05-the-wheel-gesture-over-a-place.md) | Zooming the account under the pointer | front-end | 04 | 10/10 | done |
| [06](06-snapping-on-an-arrangement-switch.md) | Snapping every account on an arrangement switch | front-end | 05 | 6/6 | done |
| [07](07-remembering-the-sizes-on-disk.md) | Remembering the sizes across a restart | full-stack | 03, 06 | 8/8 | done |
