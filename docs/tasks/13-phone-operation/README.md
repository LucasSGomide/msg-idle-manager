...
|---|---|---|---|---|---|
| [01](01-remote-vocabulary-ports-and-phone-record.md) | The remote vocabulary, its two ports, and the phone record on disk | back-end | — | 0/9 | not-started |
| [02](02-capture-script-and-wake-on-the-engine-seam.md) | Capturing a frame, running a script and waking a view on both engines | front-end | — | 0/9 | not-started |
| [03](03-the-mobile-layout-on-the-desktop.md) | The Mobile layout on the desktop | full-stack | 01 | 0/10 | not-started |
| [04](04-the-remote-server.md) | The remote server: enrolment, the socket and its proof | back-end | 01 | 0/10 | not-started |
